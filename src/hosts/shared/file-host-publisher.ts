...
export class FileHostPublisher implements HostPublisher {
  ...
  private renderEntrypoint(input: {
    ...
    return [
      ...
      "19. Every feature has a shared context ledger at `.looply/custom/features/<feature-name>/context-ledger.md`.",
      "20. Always read the `## Context Summary` section before starting work on any stage.",
      "21. After completing a workflow stage, append a `## Stage` entry with decisions, rationale, constraints discovered and risks. Update the summary.",
      "22. On low context_budget, read only the Context Summary. On medium or high budget, read the full ledger.",
      "",
      ...
      "3. If a feature is bound, read its `workflow-status.md` AND `context-ledger.md` before acting.",
