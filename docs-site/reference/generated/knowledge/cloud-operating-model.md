...
- audience: `architect`, `cloud-architect`, `platform-engineer`, `cloud-governance`, `finops`, `devops`, `sre`
- tags: `cloud`, `platform`, `operating-model`
...
- `packs/engineering-base/knowledge/cloud-operating-model.md`
